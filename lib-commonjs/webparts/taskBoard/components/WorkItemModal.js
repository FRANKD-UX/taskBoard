...
var WorkItemModal = function (_a) {
    ...
    var task = _a.task, canAssign = _a.canAssign, siteUrl = _a.siteUrl, currentUserName = _a.currentUserName, currentUserSpId = _a.currentUserSpId, incidentUserContext = _a.incidentUserContext, onSave = _a.onSave, onDelete = _a.onDelete, onClose = _a.onClose;
    var sharePointService = (0, react_1.useMemo)(function () { return new SharePointService_1.SharePointService(); }, []);
    var _m = (0, react_1.useState)(null), draft = _m[0], setDraft = _m[1];
    var _o = (0, react_1.useState)(null), assignee = _o[0], setAssignee = _o[1];
    var _p = (0, react_1.useState)(null), selectedIncidentType = _p[0], setSelectedIncidentType = _p[1];
    var _q = (0, react_1.useState)([]), incidentTypes = _q[0], setIncidentTypes = _q[1];
    var _r = (0, react_1.useState)(null), selectedIncidentTypeId = _r[0], setSelectedIncidentTypeId = _r[1];
    var _s = (0, react_1.useState)(''), severity = _s[0], setSeverity = _s[1];
    var _t = (0, react_1.useState)(true), incidentTypesLoading = _t[0], setIncidentTypesLoading = _t[1];
    var _u = (0, react_1.useState)(false), isSaving = _u[0], setIsSaving = _u[1];
    var _v = (0, react_1.useState)(''), saveError = _v[0], setSaveError = _v[1];
    var _w = (0, react_1.useState)(''), titleError = _w[0], setTitleError = _w[1];
    var _x = (0, react_1.useState)(''), incidentTypeError = _x[0], setIncidentTypeError = _x[1];
    var _y = (0, react_1.useState)([]), departments = _y[0], setDepartments = _y[1];
    var _z = (0, react_1.useState)(true), departmentsLoading = _z[0], setDepartmentsLoading = _z[1];
        ...
        var loadDepartments = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        normalizedDepartments = Array.from(new Set(data.map(function (department) { return (0, IncidentDepartmentRules_1.normalizeDepartment)(department); })))
                            .filter(function (department) { return IncidentDepartmentRules_1.ALLOWED_TASK_DEPARTMENTS.includes(department); });
                        if (isMounted) {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        department = ((_a = draft === null || draft === void 0 ? void 0 : draft.department) !== null && _a !== void 0 ? _a : '').trim();
                        if (!department) {
                            if (isMounted) {
                                setIncidentTypes([]);
                                setIncidentTypesLoading(false);
    ...
    }, [draft === null || draft === void 0 ? void 0 : draft.department, isIncidentModal, selectedIncidentTypeId, sharePointService]);
    (0, react_1.useEffect)(function () {
        ...
        if (lastTaskIdRef.current === task.id) {
            if (currentUserName) {
                setDraft(function (previousDraft) {
                    if (!previousDraft || previousDraft.createdBy)
                        return previousDraft;
                    return tslib_1.__assign(tslib_1.__assign({}, previousDraft), { createdBy: currentUserName });
                });
            }
            return;
        }
        ...
        var normalizedType = (_a = task.type) !== null && _a !== void 0 ? _a : (task.requestType === 'Incident' ? 'incident' : 'task');
        var normalizedStatus = (_b = task.status) !== null && _b !== void 0 ? _b : (normalizedType === 'incident' ? 'New' : 'Unassigned');
        ...
        var nextDraft = tslib_1.__assign(tslib_1.__assign({}, task), { type: normalizedType, requestType: toRequestType(normalizedType), status: normalizedStatus, site: (_c = task.site) !== null && _c !== void 0 ? _c : 'Albertsdal', startDate: (_d = task.startDate) !== null && _d !== void 0 ? _d : today, createdAt: (_e = task.createdAt) !== null && _e !== void 0 ? _e : new Date().toISOString(), createdBy: (_f = task.createdBy) !== null && _f !== void 0 ? _f : currentUserName, severity: normalizedType === 'incident' ? task.severity : undefined, impact: normalizedType === 'incident' ? (_g = task.impact) !== null && _g !== void 0 ? _g : '' : undefined, affectedService: normalizedType === 'incident' ? (_h = task.affectedService) !== null && _h !== void 0 ? _h : '' : undefined, incidentTypeId: normalizedType === 'incident' ? task.incidentTypeId : undefined, incidentType: null, department: (0, IncidentDepartmentRules_1.normalizeDepartment)(task.department), slaResponseMinutes: task.slaResponseMinutes, slaResolutionMinutes: task.slaResolutionMinutes, responseDueDate: task.responseDueDate, resolutionDueDate: task.resolutionDueDate, slaDeadline: task.slaDeadline, slaStatus: task.slaStatus });
        setDraft(nextDraft);
        setSelectedIncidentType(null);
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (!draft || draft.type !== 'incident' || incidentTypes.length === 0 || !selectedIncidentTypeId)
            return;
        var matching = (_a = incidentTypes.find(function (item) { return item.Id === selectedIncidentTypeId; })) !== null && _a !== void 0 ? _a : null;
        if (!matching)
            return;
        var nextSeverity = matching.Severity;
        if ((selectedIncidentType === null || selectedIncidentType === void 0 ? void 0 : selectedIncidentType.id) === matching.Id && severity === nextSeverity)
            return;
        setSelectedIncidentType({
            id: matching.Id,
            title: matching.Title,
            severity: nextSeverity,
            department: (0, IncidentDepartmentRules_1.normalizeDepartment)(matching.Department),
            isActive: matching.IsActive,
        });
        setSeverity(nextSeverity);
        setDraft(function (previousDraft) {
            if (!previousDraft || previousDraft.type !== 'incident')
                return previousDraft;
            return tslib_1.__assign(tslib_1.__assign({}, previousDraft), { incidentTypeId: matching.Id, incidentType: null, severity: nextSeverity, priority: (0, incidentSla_1.getPriorityFromSeverity)(nextSeverity) });
        });
    }, [draft, incidentTypes, selectedIncidentType, selectedIncidentTypeId, severity]);
    (0, react_1.useEffect)(function () {
        if (!draft || !isNewItem || hasFocusedTitleRef.current)
            return;
        hasFocusedTitleRef.current = true;
        var timer = window.setTimeout(function () { var _a; return (_a = titleRef.current) === null || _a === void 0 ? void 0 : _a.focus(); }, 60);
    ...
    var update = function (patch) {
        setDraft(function (previousDraft) {
            ...
            if (!previousDraft)
                return previousDraft;
            var nextType = (_a = patch.type) !== null && _a !== void 0 ? _a : previousDraft.type;
            if (patch.department !== undefined && patch.department !== previousDraft.department) {
                setSelectedIncidentType(null);
                setSelectedIncidentTypeId(null);
                setSeverity('');
                return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, previousDraft), patch), { department: (0, IncidentDepartmentRules_1.normalizeDepartment)(patch.department), requestType: toRequestType(nextType), incidentTypeId: undefined, incidentType: null, severity: undefined });
            }
            var normalizedPatch = tslib_1.__assign({}, patch);
            if (patch.department !== undefined) {
                normalizedPatch.department = (0, IncidentDepartmentRules_1.normalizeDepartment)(patch.department);
            }
            return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, previousDraft), normalizedPatch), { requestType: toRequestType(nextType) });
        });
        if ('title' in patch)
            setTitleError('');
    };
    ...
    var handleIncidentTypeChange = function (event) {
        ...
        var selectedId = Number.isFinite(nextId) && nextId > 0 ? nextId : null;
        setSelectedIncidentTypeId(selectedId);
        setIncidentTypeError('');
        var nextType = incidentTypes.find(function (item) { return item.Id === selectedId; });
        if (!nextType) {
            setSeverity('');
            update({ incidentTypeId: undefined, incidentType: null, severity: undefined });
            return;
        }
        var nextSeverity = nextType.Severity;
        setSeverity(nextSeverity);
        update({
            incidentTypeId: nextType.Id,
            incidentType: null,
            severity: nextSeverity,
            priority: (0, incidentSla_1.getPriorityFromSeverity)(nextSeverity),
        });
    };
            ...
            switch (_h.label) {
                case 0:
                    ...
                    if (draft.type === 'incident' &&
                        IncidentPolicy_1.IncidentPolicy.requiresSite({
                ...
                case 1:
                    ...
                    itemToSave = draft.type === 'incident'
                        ? tslib_1.__assign(tslib_1.__assign({}, draft), { requestType: 'Incident', incidentTypeId: effectiveIncidentTypeId !== null && effectiveIncidentTypeId !== void 0 ? effectiveIncidentTypeId : undefined, incidentType: effectiveIncidentTypeId
                                ...
                                : null, severity: (severity || (selectedIncidentType === null || selectedIncidentType === void 0 ? void 0 : selectedIncidentType.severity) || draft.severity), impact: ((_f = draft.impact) !== null && _f !== void 0 ? _f : '').trim(), affectedService: ((_g = draft.affectedService) !== null && _g !== void 0 ? _g : '').trim() }) : tslib_1.__assign(tslib_1.__assign({}, draft), { type: 'task', requestType: 'Task', severity: undefined, impact: undefined, affectedService: undefined, incidentTypeId: undefined, incidentType: null, responseDueDate: undefined, resolutionDueDate: undefined, slaResponseMinutes: undefined, slaResolutionMinutes: undefined, slaDeadline: undefined, slaStatus: undefined });
    ...
    var canClaimCurrentIncident = draft.type === 'incident' &&
        IncidentAssignmentService_1.IncidentAssignmentService.canClaimIncident(incidentUserContext, incidentAssignmentInput);
    var canAssignIncidentToOthers = draft.type === 'incident' &&
        incidentUserContext.canAssign === true &&
        IncidentAssignmentService_1.IncidentAssignmentService.canAssignIncident(incidentUserContext, incidentAssignmentInput, { id: -1, department: draft.department });
    ...
    return (React.createElement("div", { style: overlayStyle, onClick: onClose },
        React.createElement("div", { style: modalStyle, onClick: function (event) { return event.stopPropagation(); } },
            ...
            React.createElement("div", { style: bodyStyle },
                ...
                (canEditAssignee || canClaimCurrentIncident) && (React.createElement("div", null,
                    canEditAssignee && (React.createElement(React.Fragment, null,
                    ...
                    draft.type === 'incident' && canClaimCurrentIncident && currentUserSpId && (React.createElement("button", { type: "button", onClick: function () { return handleAssigneeChange({
                            id: currentUserSpId,
                ...
                React.createElement("div", null,
                    ...
                    React.createElement("select", { id: "wim-site", value: (_c = draft.site) !== null && _c !== void 0 ? _c : 'Albertsdal', onChange: function (event) { return update({ site: event.target.value }); }, style: inputStyle }, SITES.map(function (site) { return (React.createElement("option", { key: site.value, value: site.value }, site.label)); }))),
                    ...
                    React.createElement("div", { style: gridTwoStyle },
                        React.createElement("div", null,
                            ...
                            React.createElement("select", { id: "wim-incident-type", value: selectedIncidentTypeId !== null && selectedIncidentTypeId !== void 0 ? selectedIncidentTypeId : '', onChange: handleIncidentTypeChange, disabled: incidentTypesLoading, style: tslib_1.__assign(tslib_1.__assign({}, inputStyle), { borderColor: incidentTypeError ? '#ef4444' : theme_1.THEME.colors.border, opacity: incidentTypesLoading ? 0.7 : 1 }) },
                                ...
                                !incidentTypesLoading && incidentTypes.length === 0 && React.createElement("option", { value: "" }, "No incident types"),
                        ...
                        React.createElement("div", null,
                            ...
                            React.createElement("div", { style: tslib_1.__assign(tslib_1.__assign({}, severityTagBaseStyle), severityBadgeStyle) }, derivedSeverity || 'Not selected'))),
                    React.createElement("div", null,
                        React.createElement("label", { style: labelStyle, htmlFor: "wim-affected-service" }, "Affected Service"),
                        React.createElement("input", { id: "wim-affected-service", type: "text", value: (_d = draft.affectedService) !== null && _d !== void 0 ? _d : '', onChange: function (event) { return update({ affectedService: event.target.value }); }, placeholder: "Email, network, ERP, payroll...", style: inputStyle })),
                    React.createElement("div", null,
                        React.createElement("label", { style: labelStyle, htmlFor: "wim-impact" }, "Impact"),
                        React.createElement("textarea", { id: "wim-impact", value: (_e = draft.impact) !== null && _e !== void 0 ? _e : '', onChange: function (event) { return update({ impact: event.target.value }); }, placeholder: "Describe business impact and affected users", rows: 3, style: tslib_1.__assign(tslib_1.__assign({}, inputStyle), { resize: 'vertical', minHeight: '80px' }) })))),
                React.createElement("div", { style: gridTwoStyle },
                    React.createElement("div", null,
                        ...
                        React.createElement("input", { id: "wim-start-date", type: "date", value: (_g = (_f = draft.startDate) === null || _f === void 0 ? void 0 : _f.split('T')[0]) !== null && _g !== void 0 ? _g : '', onChange: function (event) { return update({ startDate: event.target.value }); }, style: isNewItem ? tslib_1.__assign(tslib_1.__assign({}, inputStyle), { opacity: 0.6, cursor: 'not-allowed' }) : inputStyle, readOnly: isNewItem })),
                    React.createElement("div", null,
                        React.createElement("label", { style: labelStyle, htmlFor: "wim-due-date" }, "Due Date"),
                        React.createElement("input", { id: "wim-due-date", type: "date", value: (_j = (_h = draft.dueDate) === null || _h === void 0 ? void 0 : _h.split('T')[0]) !== null && _j !== void 0 ? _j : '', min: (_k = draft.startDate) === null || _k === void 0 ? void 0 : _k.split('T')[0], onChange: function (event) { return update({ dueDate: event.target.value }); }, style: inputStyle }))),
                React.createElement("div", null,
                    React.createElement("label", { style: labelStyle, htmlFor: "wim-department" }, "Department"),
                    React.createElement("select", { id: "wim-department", value: draft.department, onChange: function (event) { return update({ department: (0, IncidentDepartmentRules_1.normalizeDepartment)(event.target.value) }); }, style: inputStyle }, departmentsLoading ? (React.createElement("option", null, "Loading...")) : departments.length === 0 ? (React.createElement("option", null, "No departments")) : (departments.map(function (department) { return (React.createElement("option", { key: department, value: department }, department)); })))),
                React.createElement("div", null,
                    React.createElement("label", { style: labelStyle, htmlFor: "wim-description" }, "Description"),
                    React.createElement("textarea", { id: "wim-description", value: (_l = draft.description) !== null && _l !== void 0 ? _l : '', onChange: function (event) { return update({ description: event.target.value }); }, placeholder: draft.type === 'incident' ? 'Add incident notes...' : 'Add a description...', rows: 3, style: tslib_1.__assign(tslib_1.__assign({}, inputStyle), { resize: 'vertical', minHeight: '80px' }) })),
