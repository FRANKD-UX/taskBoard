...
var ChartView = function (_a) {
    ...
    var renderLegend = function (slices) { return (React.createElement("div", { style: { display: 'grid', gap: '10px' } }, slices.map(function (slice) { return (React.createElement("div", { key: slice.label, style: {
            display: 'flex',
            alignItems: 'center',
