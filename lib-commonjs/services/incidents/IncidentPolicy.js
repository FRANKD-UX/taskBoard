...
var canCreateIncident = function (user, department, incidentTypeTitle) {
    var actorId = getUserId(user);
    if (actorId === null || !department)
        return false;
    if (incidentTypeTitle && !(0, IncidentCatalog_1.findIncidentCatalogEntry)(department, incidentTypeTitle)) {
        return false;
    }
