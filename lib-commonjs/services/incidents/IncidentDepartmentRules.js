...
var normalizeDepartmentKey = function (department) {
    return (department !== null && department !== void 0 ? department : '').toLowerCase().trim();
};
...
var isDepartmentSupported = function (department) {
    var normalized = normalizeDepartmentKey(department);
    if (!normalized)
        return false;
